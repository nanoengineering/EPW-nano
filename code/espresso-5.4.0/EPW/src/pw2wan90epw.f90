...
!
 ...
 !    close (iuukk)
      !
      ! THL
      OPEN (UNIT=iuukk,FILE=filukk,FORM='unformatted',ACCESS='direct',RECL=2*iknum*nbnd*n_wannier*DP+iknum*nbnd*4,STATUS='replace')
      WRITE (iuukk,REC=1) u_kc(1:nbnd,1:n_wannier,1:iknum), lwindow(1:nbnd,1:iknum)
      CLOSE (iuukk)
      !
