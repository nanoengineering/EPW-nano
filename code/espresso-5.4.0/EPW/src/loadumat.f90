...
!      close ( iunukk )
      !
      ! THL
      OPEN (UNIT=iunukk,FILE=filukk,FORM='unformatted',ACCESS='direct',RECL=2*nkstot*nbnd*nbndsub*DP+nkstot*nbnd*4,STATUS='old')
      READ (iunukk,REC=1) cu_big (1:nbnd,1:nbndsub,1:nkstot), lwin_big(1:nbnd,1:nkstot)
      CLOSE (iunukk)
      !
