...
subroutine bcast_ph_input ( )
  ...
  USE control_ph, ONLY : start_irr, last_irr, start_q, last_q, nmix_ph, &
                         ...
                         eph_bndmin, eph_bndmax, eph_xk, lrange_eph, ext_dvscf
  ...
  call mp_bcast (eph_xk, meta_ionode_id, world_comm)
  call mp_bcast (lrange_eph, meta_ionode_id, world_comm)
  call mp_bcast (ext_dvscf, meta_ionode_id, world_comm)
  ! YAMBO >
  ...
  CALL mp_bcast( eph_bndmin, meta_ionode_id, world_comm )
  CALL mp_bcast( eph_bndmax, meta_ionode_id, world_comm )
